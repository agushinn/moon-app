            ...
            <g>
                <g>
                    <g>
                        <path
                            fill="#fff"
                            d="M496.067,123.305c-54.705,0-99.213,44.508-99.213,99.213c0,47.453,70.305,143.494,86.777,165.353
				...
				c0-41.032,33.378-74.41,74.41-74.41s74.41,33.378,74.41,74.41C570.477,254.092,523.329,325.473,496.067,362.982z"
                        ...
                        <path
                            fill="#fff"
                            d="M496.067,197.715c-13.673,0-24.803,11.13-24.803,24.803s11.13,24.803,24.803,24.803
				s24.803-11.129,24.803-24.803C520.87,208.845,509.74,197.715,496.067,197.715z"
                        />
                        <path
                            fill="#fff"
                            d="M148.82,396.142c-41.032,0-74.41,33.378-74.41,74.41s33.378,74.41,74.41,74.41s74.41-33.378,74.41-74.41
				...
				s49.607,22.247,49.607,49.607C198.427,497.912,176.178,520.158,148.82,520.158z"
                        ...
                        <path
                            fill="#fff"
                            d="M336.674,570.274c-6.419-2.495-13.565,0.691-16.047,7.085c-5.559,14.363-12.51,31.113-21.885,46.457
				...
				c10.392-17.028,17.887-35.049,23.846-50.43C346.23,579.938,343.057,572.757,336.674,570.274z"
                        ...
                        <path
                            fill="#fff"
                            d="M266.745,660.779c-12.426,9.846-26.547,17.258-43.188,22.672c-6.516,2.12-10.077,9.12-7.957,15.635
				...
				c5.366-4.263,6.274-12.063,2.023-17.428C279.885,657.449,272.098,656.492,266.745,660.779z"
                        ...
                        <path
                            fill="#fff"
                            d="M379.607,480.737c-20.467,11.615-31.839,31.779-38.622,45.925c-2.967,6.177-0.364,13.589,5.813,16.543
				...
				c5.947-3.379,8.042-10.949,4.651-16.907C393.148,479.429,385.602,477.334,379.607,480.737z"
                        ...
                        <path
                            fill="#fff"
                            d="M491.464,450.036c-5.632-3.815-13.371-2.35-17.222,3.318c-4.081,6.032-12.438,14.327-37.714,16.592
				...
				c26.85-2.41,45.174-11.372,56.026-27.396C498.623,461.589,497.132,453.875,491.464,450.036z"
                        ...
                        <path
                            fill="#fff"
                            d="M178.206,693.943c39.132-41.73,119.434-137.733,119.434-223.39c0-83.445-65.375-148.82-148.82-148.82
